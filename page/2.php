...
<body>
  ...
  <?php
    ...
    $sql = "SELECT * FROM life_podcat WHERE id = '$wid'";
            ...
            <div class="c-las">
                <i class="fa-solid fa-arrow-left button" id="prev"></i>
                    <div class="image-container">
                         <div class="carousel">
                         <iframe  src="<?= $data['YT_URL']; ?>" frameborder="0" allowfullscreen></iframe>
                              <img src="<?= $data['Image_URL_Sec2']; ?>" alt="" />
                              <img src="<?= $data['Image_URL_Sec3']; ?>" alt="" />
                               <img src="<?= $data['Image_URL_Sec4']; ?>" alt="" />
                         </div>
