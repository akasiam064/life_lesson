...
<head>
    ...
    <link rel="stylesheet" href="/css/editprofire.css">
        ...
        <a href="/index.html">
          ...
          <div class="setting-contai">
            ...
            <div class="detail-setting">
                ...
                <div class="acconting">
                  <input placeholder="ชื่อผูัใช้ อังกฤษเท่านั้น" class="input-style" type="text">
                  <input placeholder="ชื่อ" class="input-style" type="text">
                  <input placeholder="นามสกุล" class="input-style" type="text">
                  <input placeholder="Email" class="input-style" type="email">
                </div>
