...
echo 'img4';
    ...
    $checkDuplicateQuery = "SELECT * FROM life_Book WHERE name = '$name'";
    ...
    if (mysqli_num_rows($checkDuplicateResult) > 0) {
        ...
        $sql = "INSERT INTO life_book (name, detail, refer, Image_URL_Sec1,Image_URL_Sec2,Image_URL_Sec3,Image_URL_Sec4) 
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            header('Location: ../create/create_book.php');
            exit;
        } else {
