        ...
        <div class="container">
            <div class="shadow rounded p-5 bg-body h-100">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <h1 class="pb-4"> แสดงข้อมูล BLOG </h1>
                        <a href="../php/create/create_blog.php">
                        ...
                        <?php 
                         ...
                         $sql = "SELECT COUNT(*) as id From life_blog";
                        ...
                        <span class="float-end" >มีข้อมูล BLOG ทั้งหมด <?= $fetch['id'] ?> รายการ </span>     
                    </div>
                    <div class="col-lg-10">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a href="../php/delete/delete_blog.php?id=<?=$data['id']?>">
